        ...
        <div className="glass-card rounded-xl p-5 border border-slate-700/50">
          ...
          {(() => {
            ...
            if (!isConnected) {
              ...
              const isBridgeActive = bridgeStatus?.extensionRecentlyActive && ssidStatus === "VALID";
              
              if (isBridgeActive) {
                return (
                  <div className="mt-4 bg-blue-500/10 border border-blue-500/30 rounded-xl p-4 text-blue-400 text-sm flex items-start gap-3">
                    <svg className="w-5 h-5 shrink-0 mt-0.5 animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
                    <div>
                      <div className="font-bold mb-1">Synchronisation en cours...</div>
                      <p className="text-xs text-blue-400/80">
                        Le Bridge est actif et le SSID est validé. Le serveur initialise actuellement la connexion sécurisée avec le flux de trading PocketOption. Veuillez patienter.
                      </p>
                    </div>
                  </div>
                );
