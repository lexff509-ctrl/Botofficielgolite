...
import { getUserFromRequest, handleApiError, hashPassword } from "@/lib/auth";
...
export async function PUT(
  ...
  try {
    ...
    if (parsed.data.resetPassword) updateData.password = await hashPassword(parsed.data.resetPassword);
